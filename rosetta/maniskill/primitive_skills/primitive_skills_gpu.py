...
class PrimitiveSkillDelta():
    ...
    def _pick(self, obs, params, robot_id=0, speed=0.5, thresh=0.005, yaw_thresh=0.005,max_steps=None):       
        ...
        above_pos = (goal_pos[0], goal_pos[1], goal_pos[2]+self.waypoint_height)
        ...
        if self.phase == 0:
            ...
            rst = self._move_to(obs=obs, params=params, robot_id=robot_id, speed=speed, thresh=thresh, yaw_thresh=yaw_thresh, count_steps=False)
            action, skill_done, self.prev_success = rst["action"], rst["skill_done"], rst["skill_success"]
    ...
    def _push(self, obs, params, robot_id=0, speed=0.5, thresh=0.005, yaw_thresh=0.005):
        ...
        above_start_pos = (start_pos[0], start_pos[1], start_pos[2]+self.waypoint_height)
        above_end_pos = (end_pos[0], end_pos[1], end_pos[2]+self.waypoint_height)
        ...
        if self.phase == 2:
            ...
            rst = self._move_to(obs=obs, params=params, robot_id=robot_id, speed=speed, thresh=0.03, yaw_thresh=yaw_thresh, count_steps=False, slow_speed=0.5)
            action, skill_done, self.prev_success= rst["action"], rst["skill_done"], rst["skill_success"]
