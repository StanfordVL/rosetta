...
def rosetta_sh_nohistory(
    ...
    **kwargs,
    ...
    env_code_no_reward = replace_methods(
        env_code, {"evaluate": "", "compute_dense_reward": ""}
    )
    ...
    user_geom_msg = PromptMessage(
        role="user", content=get_prompt_content(f"{content_version}/fcode_geomcot_user")
    )
    ...
    user_targets_msg = PromptMessage(
        role="user",
        content=get_prompt_content(f"{content_version}/fcode_targetscot_user"),
    )
    ...
    user_dense_msg = PromptMessage(
        role="user",
        content=get_prompt_content(f"{content_version}/fcode_densecot_user"),
    )
    ...
    user_masking_msg = PromptMessage(
        role="user",
        content=get_prompt_content(f"{content_version}/fcode_maskingcot_user"),
    )
